...
uv run helio-agent list                     # 65 tools in six families
...
- **measure** — flare detection + GOES classification, storm metrics,
  ...
  plasma parameters (PlasmaPy), ICME/shock/sheath detection, SEP radiation-storm characterization, type II/III radio bursts, claim verification

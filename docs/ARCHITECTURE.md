...
| Tool layer | 66 tools wrapping HEASoft, XSPEC, CIAO, SAS, Fermitools | 62 tools wrapping sunpy, pyspedas, plasmapy, geopack, cdasws, sscws, hapiclient, cdflib + HDRL/NOAA REST services |

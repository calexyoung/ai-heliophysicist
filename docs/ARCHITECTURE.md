...
| Tool layer | 66 tools wrapping HEASoft, XSPEC, CIAO, SAS, Fermitools | 53 tools wrapping sunpy, pyspedas, plasmapy, cdasws, sscws, hapiclient, cdflib + HDRL/NOAA REST services |

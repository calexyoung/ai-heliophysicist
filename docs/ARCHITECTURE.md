...
| Tool layer | 66 tools wrapping HEASoft, XSPEC, CIAO, SAS, Fermitools | 55 tools wrapping sunpy, pyspedas, plasmapy, geopack, cdasws, sscws, hapiclient, cdflib + HDRL/NOAA REST services |

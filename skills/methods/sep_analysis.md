...
## Data
- **GOES integral channels** (>1, >5, >10, >30, >50, >60, >100 MeV; SEISS on GOES-16+, EPEAD before) are the NOAA reference. Real-time: SWPC `/json/goes/primary/integral-protons-*.json` (`get_noaa_realtime`, not science quality). Science: NOAA NCEI archive via sunpy/GOES-R netCDF.
